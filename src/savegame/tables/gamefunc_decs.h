...
extern byte P_DamageModifier ( const edict_t * ent ) ;
...
extern void DeathmatchScoreboardMessage ( const edict_t * ent , const edict_t * killer ) ;
...
extern void widow_gib_touch ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void widow2_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void widow_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void turret_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void stalker_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void CarrierPrecache ( void ) ;
extern qboolean Carrier_CheckAttack ( edict_t * self ) ;
extern void carrier_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern edict_t * findradius2 ( edict_t * from , const vec3_t org , float rad ) ;
...
extern void G_ProjectSource2 ( const vec3_t point , const vec3_t distance , const vec3_t forward , const vec3_t right , const vec3_t up , vec3_t result ) ;
...
extern void hunter_touch ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void sphere_if_idle_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
extern void sphere_explode ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void tracker_touch ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void blaster2_touch ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void tesla_lava ( edict_t * ent , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
extern void tesla_think ( edict_t * ent ) ;
extern void tesla_activate ( edict_t * self ) ;
extern void tesla_think_active ( edict_t * self ) ;
extern void tesla_zap ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
extern void tesla_blow ( edict_t * self ) ;
extern void tesla_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
extern void tesla_remove ( edict_t * self ) ;
extern void fire_nuke ( edict_t * self , vec3_t start , vec3_t aimdir , int speed ) ;
extern void nuke_bounce ( edict_t * ent , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
extern void Nuke_Think ( edict_t * ent ) ;
extern void nuke_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void prox_land ( edict_t * ent , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
extern void prox_open ( edict_t * ent ) ;
extern void prox_seek ( edict_t * ent ) ;
extern void Prox_Field_Touch ( edict_t * ent , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
extern void prox_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void flechette_touch ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void trigger_disguise_touch ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void trigger_teleport_touch ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void secret_touch ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void fd_secret_killed ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void doppleganger_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
extern void PrecacheForRandomRespawn ( void ) ;
extern edict_t * DoRandomRespawn ( edict_t * ent ) ;
extern const char * FindSubstituteItem ( edict_t * ent ) ;
...
extern void badarea_touch ( edict_t * ent , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void hint_path_touch ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void Use_Hunter ( edict_t * ent , const gitem_t * item ) ;
extern void Use_Defender ( edict_t * ent , const gitem_t * item ) ;
extern qboolean Pickup_Sphere ( edict_t * ent , edict_t * other ) ;
extern qboolean Pickup_Doppleganger ( edict_t * ent , edict_t * other ) ;
extern void Use_Doppleganger ( edict_t * ent , const gitem_t * item ) ;
extern void Use_Nuke ( edict_t * ent , const gitem_t * item ) ;
extern void Use_Compass ( edict_t * ent , const gitem_t * item ) ;
extern void Use_Double ( edict_t * ent , const gitem_t * item ) ;
extern void Use_IR ( edict_t * ent , const gitem_t * item ) ;
...
extern void Touch_Plat_Center2 ( edict_t * ent , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void Tag_DogTag ( const edict_t * ent , const edict_t * killer , char * * pic ) ;
...
extern void DBall_SpeedTouch ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
extern void DBall_BallRespawn ( edict_t * self ) ;
extern void DBall_BallDie ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
extern void DBall_BallPain ( edict_t * self , edict_t * other , float kick , int damage ) ;
extern void DBall_BallTouch ( edict_t * ent , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
extern edict_t * PickBallStart ( edict_t * ent ) ;
extern void DBall_GoalTouch ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
