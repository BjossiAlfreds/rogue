...
// monsterinfo.blocked
extern qboolean berserk_blocked (edict_t *, float);
extern qboolean chick_blocked (edict_t *, float);
extern qboolean floater_blocked (edict_t *, float);
extern qboolean flyer_blocked (edict_t *, float);
extern qboolean gladiator_blocked (edict_t *, float);
extern qboolean gunner_blocked (edict_t *, float);
extern qboolean hover_blocked (edict_t *, float);
extern qboolean infantry_blocked (edict_t *, float);
extern qboolean medic_blocked (edict_t *, float);
extern qboolean mutant_blocked (edict_t *, float);
extern qboolean parasite_blocked (edict_t *, float);
extern qboolean soldier_blocked (edict_t *, float);
extern qboolean stalker_blocked (edict_t *, float);
extern qboolean supertank_blocked (edict_t *, float);
extern qboolean tank_blocked (edict_t *, float);
extern qboolean widow_blocked (edict_t *, float);
// moveinfo.endfunc
